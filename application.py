...
@app.route('/',methods=['GET','POST']) #route is home page / get data from html and post results 
def index():
...
#convert all this to numpy array 
        ...
        return render_template('index.html', prediction=prediction[0])# I want 1 or 0 as prediction 
