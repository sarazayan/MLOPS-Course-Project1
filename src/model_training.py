import os #to create direectories 
import pandas as pd
...
try:
    ...
    print("✓ Paths imported successfully")
except ImportError as e:
    print("✗ Paths import failed:", e)
...
try:
    ...
    print("✓ Model params imported successfully")
except ImportError as e:
    print("✗ Model params import failed:", e)
    # Fallback - define them directly
...
# Debug prints
print("LIGHTGM_PARAMS loaded successfully:", type(LIGHTGM_PARAMS))
print("RANDOM_SEARCH_PARAMS loaded successfully:", type(RANDOM_SEARCH_PARAMS))
